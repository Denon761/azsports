      ...
      <section className="py-16 lg:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 space-y-8 shadow-sm">
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">1. Terms</h2>
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">2. Use License</h2>
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">3. Disclaimer</h2>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">4. Limitations</h2>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">5. Accuracy of Materials</h2>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">6. Links</h2>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">7. Modifications</h2>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-4">8. Governing Law</h2>
