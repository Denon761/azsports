    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="py-16 lg:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-10 mb-8 shadow-sm">
            <p className="text-gray-600 mb-6">
              Last updated: {new Date().toLocaleDateString()}
            </p>

            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">What Are Cookies?</h2>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
              Cookies are small text files that are placed on your computer or mobile device when you visit a website. 
              They are widely used to make websites work more efficiently and provide information to website owners.
            </p>

            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">How We Use Cookies</h2>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">Managing Your Cookies</h2>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
              You have the right to decide whether to accept or reject cookies. You can manage your cookie preferences 
              in various ways:
            </p>
            <ul className="list-disc list-inside text-gray-600 text-sm md:text-base space-y-2 ml-4 mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">Specific Cookies We Use</h2>
            ...
            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">Updates to This Policy</h2>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">Contact Us</h2>
